<p align="center">
  <br>
  <img src="./src/assets/koole-logo.svg" width="120" alt="Koole">
  <br>
...
```bash
git clone https://github.com/your-username/Koole.git
cd Koole
```
...
│   │   │   └── SearchBar.vue
│   │   ├── constants/            # 常量配置
│   │   │   ├── physicsModels.js  # 16 个物理模型定义
│   │   │   └── modelTypes.js     # 沙盒物体类型
│   │   ├── physics/              # 物理引擎核心
│   │   │   ├── core/             # 物体类（Ball, Box, Triangle...）
│   │   │   └── collision.js      # 碰撞检测
│   │   ├── route/                # 路由配置
│   │   ├── stores/               # 状态管理
│   │   │   ├── theme.js          # 主题切换
...
│   │   └── views/                # 页面组件
│   │       ├── HomeIndex.vue     # 首页
│   │       ├── ArticleView.vue   # 文章列表
│   │       ├── ArticleDetail.vue # 文章详情
│   │       ├── ArticleEditor.vue # 文章编辑器
│   │       ├── UpdatePostView.vue# 更新日志
│   │       ├── PhysicsLab.vue    # 物理实验室
│   │       ├── classic/          # 经典模型页面
│   │       │   ├── ClassicPhysicsLayout.vue
│   │       │   ├── ClassicModelView.vue
│   │       │   ├── ModelInfoPanel.vue
│   │       │   └── ComparisonPanel.vue
│   │       └── SandBox.vue       # 沙盒模式
│   └── package.json
...
- [ECharts](https://echarts.apache.org/) — 数据可视化（轨迹对比）
- [md-editor-v3](https://imzbf.github.io/md-editor-v3/) — Markdown 编辑与预览
- Canvas 2D — 物理模拟渲染（无外部物理引擎依赖）

**后端**
- [Spring Boot 4](https://spring.io/projects/spring-boot) — 应用框架
- [Spring Data JPA](https://spring.io/projects/spring-data-jpa) — ORM
- [Spring Security](https://spring.io/projects/spring-security) — 认证授权
- [JWT (jjwt)](https://github.com/jwtk/jjwt) — 令牌认证
- [MySQL 8](https://www.mysql.com/) — 数据库

## 🎯 特色

- **纯 Canvas 自研物理引擎** — 没有使用 Box2D / Matter.js，每个模型手动推公式，适合教学演示
- **深色/浅色主题** — 跟随系统偏好 or 手动切换，localStorage 持久化
- **实时轨迹对比** — 同屏展示多条轨迹，直观感受参数变化的影响
- **交互式参数面板** — 滑块调节、实时反馈，所见即所得
